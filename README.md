# Python (Flask) service for Wodby

Use Python (Flask) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Python (Flask) service in the Wodby catalog.
...
4. Reference `flask` from your stack manifest.
