# Python (Flask) service for Kubernetes on Wodby

Build and run Python (Flask) applications on Kubernetes with Wodby.

This repository defines the Wodby service manifests and operational
configuration for Python (Flask).
...
Use this service through [Flask application stack](https://github.com/wodby/stack-flask), or reference `flask` from a custom
Wodby stack.
